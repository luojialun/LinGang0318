...
public class NormalSelectionDialog {
    ...
    private void loadItem() {
        ...
        if (mBuilder.getTitleVisible()) {
            ...
            if (datas.size() != 0) {
                title.setBackgroundResource(R.drawable.selector_camera_dialog_top);

            } else {
                title.setBackgroundResource(R.drawable.selector_camera_dialog_single);
            }
        } else {
        ...
        //设置底部“取消”按钮
        bottomBtn.setTextColor(mBuilder.getCancleButtonTextColor());
        bottomBtn.setTextSize(mBuilder.getCancleButtonTextSize());
        ...
        if (datas.size() == 1) {
            ...
            if (mBuilder.getTitleVisible())
                button.setBackgroundResource(R.drawable.selector_camera_dialog_bottom);
            else button.setBackgroundResource(R.drawable.selector_camera_dialog_single);
            ...
            for (int i = 0; i < datas.size(); i++) {
                ...
                if (!mBuilder.getTitleVisible() && i == 0) {
                    button.setBackgroundResource(R.drawable.selector_camera_dialog_top);
                } else {
                    if (i != datas.size() - 1)
                        button.setBackgroundResource(R.drawable
                                .selector_camera_dialog_middle);
                    else
                        button.setBackgroundResource(R.drawable
                                .selector_camera_dialog_bottom);
                }
                linearLayout.addView(button);
            }
        }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (mBuilder.getOnItemListener() != null) {
                    ...
                    mBuilder.getOnItemListener().onItemClick(button, datas,selectPosition);
...
//
    ...
    public static class Builder {
        ...
        private int cancleButtonTextColor;
        private float cancleButtonTextSize;
        ...
        public Builder(Context context) {
            ...
            itemWidth = 0.92f;
            itemTextColor = ContextCompat.getColor(mContext, R.color.black_80); // 默认字体颜色
        ...
        public int getCancleButtonTextColor() {
            return cancleButtonTextColor;
        }

        public Builder setCancleButtonTextColor(@ColorRes int cancleButtonTextColor) {
            this.cancleButtonTextColor =  ContextCompat.getColor(mContext, cancleButtonTextColor);
            return this;
        }

        public float getCancleButtonTextSize() {
            return cancleButtonTextSize;
        }

        public Builder setCancleButtonTextSize(float cancleButtonTextSize) {
