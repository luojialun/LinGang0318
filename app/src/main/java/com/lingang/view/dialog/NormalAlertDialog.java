...
public class NormalAlertDialog implements View.OnClickListener {
    ...
    //设置单个按钮按钮文本
    public void setSingleBtnText(String title) {
        mSingleBtn.setText(title);
    }
    ...
    public void setEnable(boolean enable)
    {
        ...
        mRightBtn.setTextColor(mContext.getResources().getColor(R.color.black_40));
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            contentText = "";
            contentTextColor = ContextCompat.getColor(mContext, R.color.black);
            isSingleMode = false;
            singleButtonText = "确定";
            singleButtonTextColor = ContextCompat.getColor(mContext, R.color.black);
            leftButtonText = "取消";
            leftButtonTextColor = ContextCompat.getColor(mContext, R.color.black);
            rightButtonText = "确定";
            rightButtonTextColor = ContextCompat.getColor(mContext, R.color.black);
