...
public class LockPatternIndicator extends View {
    ...
    private void initAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.LockPatternIndicator_indicatorDefaultColor) {
            setDefaultPaint(typedArray.getColor(R.styleable.LockPatternIndicator_indicatorDefaultColor, 0));
        } else if (attr == R.styleable.LockPatternIndicator_indicatorSelectColor) {
            setSelectPaint(typedArray.getColor(R.styleable.LockPatternIndicator_indicatorSelectColor, 0));
        }
    }
    ...
    private void initPaint() {
        ...
        defaultPaint.setColor(getResources().getColor(R.color.b2b2b2));
        defaultPaint.setStrokeWidth(3.0f);
        defaultPaint.setStyle(Style.STROKE);
        defaultPaint.setAntiAlias(true);

        selectPaint = new Paint();
        selectPaint.setColor(getResources().getColor(R.color.c_01aaee));
