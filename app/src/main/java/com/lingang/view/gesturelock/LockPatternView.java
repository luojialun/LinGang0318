package com.lingang.view.gesturelock;
...
public class LockPatternView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LockPatternIndicator);
    ...
    private void initAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.LockPatternView_defaultColor) {
            setDefaultPaint(typedArray.getColor(R.styleable.LockPatternView_defaultColor, getResources().getColor(R.color.c_78d2f6)));
        } else if (attr == R.styleable.LockPatternView_selectColor) {
            setSelectPaint(typedArray.getColor(R.styleable.LockPatternView_selectColor, getResources().getColor(R.color.c_00aaee)));
        } else if (attr == R.styleable.LockPatternView_errorColor) {
            setErrorPaint(typedArray.getColor(R.styleable.LockPatternView_errorColor, getResources().getColor(R.color.f3323b)));
        }
    }

    public void setErrorPaint(int errorColor) {
        errorPaint.setColor(errorColor);
    }

    public void setSelectPaint(int selectColor) {
        selectPaint.setColor(selectColor);
    }

    public void setDefaultPaint(int defaultColor) {
    ...
    private void initPaints() {
        ...
        defaultPaint.setColor(getResources().getColor(R.color.a6a6a6));
        defaultPaint.setStrokeWidth(2.0f);
        defaultPaint.setStyle(Style.STROKE);
        defaultPaint.setAntiAlias(true);

        selectPaint = new Paint();
        selectPaint.setColor(getResources().getColor(R.color.word_orange_color_F57725));
        selectPaint.setStrokeWidth(3.0f);
        selectPaint.setStyle(Style.STROKE);
        selectPaint.setAntiAlias(true);

        errorPaint = new Paint();
        errorPaint.setColor(getResources().getColor(R.color.f3323b));
