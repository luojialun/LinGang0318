...
public class LvMatingPerAdapter extends BaseAdapter {

    private Context context;
    private LayoutInflater mInflater;
    private List<MatingDetailesBean.DataBean.UmanagersBean> data;

    public LvMatingPerAdapter(Context context, List<MatingDetailesBean.DataBean.UmanagersBean> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GlideImgManager.glideLoader(context, HttpApi.IMAGE_BASE_SERVER + data.get(position).getImgPath(),holder.img_per_entry);
        holder.tv_per_name.setText(data.get(position).getUmanagerName());
        return convertView;
    }
