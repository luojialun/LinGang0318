 ...
 * @class describe
 */
public class CoopFragment extends BaseFragment implements RefreshListion ,RecycleBaseAdapter.OnItemClickListener{
    ...
    private PartnerAdapter newAddAdapter;
    ...
    private void initView() {
        ...
        newAddAdapter = new PartnerAdapter(getActivity(), clusterData);
    ...
    private void queryMessageList(final String pageIndex) {
        ...
        OkGo.post(HttpApi.queryMessageList)
                .params(httpParams)
                .execute(new ResCallBack<PartnerBean>(getActivity(),false) {
                    @Override
    ...
    public void onItemClick(View view, Object item, int position) {
        startActivity(new Intent(getActivity(), PartnerDetailsAc.class).putExtra("id", clusterData.get(position).getPartnerId()));
