 ...
 * @class describe
 */
public class JoinFragment extends BaseFragment implements RefreshListion ,RecycleBaseAdapter.OnItemClickListener{
    ...
    private EntryAdapter newAddAdapter;
    ...
    private void initView() {
        ...
        newAddAdapter = new EntryAdapter(getActivity(), clusterData);
    ...
    private void queryMessageList(final String pageIndex) {
        ...
        OkGo.post(HttpApi.queryMessageList)
                .params(httpParams)
                .execute(new ResCallBack<EntryBean>(getActivity(),false) {
                    @Override
    ...
    public void onItemClick(View view, Object item, int position) {
        startActivity(new Intent(getActivity(), EntryDetailsAc.class).putExtra("id", clusterData.get(position).getStationId()));
    }
}
