...
public class EntryAc_ViewBinding implements Unbinder {
  private EntryAc target;
  ...
  @UiThread
  public EntryAc_ViewBinding(EntryAc target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public EntryAc_ViewBinding(final EntryAc target, View source) {
    this.target = target;
