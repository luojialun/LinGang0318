...
public class SearchClusterFragment_ViewBinding implements Unbinder {
  private SearchClusterFragment target;

  @UiThread
  public SearchClusterFragment_ViewBinding(SearchClusterFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SearchClusterFragment target = this.target;
