...
public class SeachMatingAc_ViewBinding implements Unbinder {
  private SeachMatingAc target;
  ...
  @UiThread
  public SeachMatingAc_ViewBinding(SeachMatingAc target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SeachMatingAc_ViewBinding(final SeachMatingAc target, View source) {
    this.target = target;
    ...
    target.llMating = Utils.findRequiredViewAsType(source, R.id.ll_mating, "field 'llMating'", LinearLayout.class);
  ...
  @CallSuper
  public void unbind() {
    SeachMatingAc target = this.target;
