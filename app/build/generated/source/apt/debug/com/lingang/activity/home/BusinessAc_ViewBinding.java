...
public class BusinessAc_ViewBinding implements Unbinder {
  private BusinessAc target;
  ...
  @UiThread
  public BusinessAc_ViewBinding(BusinessAc target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public BusinessAc_ViewBinding(final BusinessAc target, View source) {
    this.target = target;
