...
public class SeachYuanQuAc_ViewBinding implements Unbinder {
  private SeachYuanQuAc target;
  ...
  @UiThread
  public SeachYuanQuAc_ViewBinding(SeachYuanQuAc target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SeachYuanQuAc_ViewBinding(final SeachYuanQuAc target, View source) {
    this.target = target;
    ...
    target.acYuanQu = Utils.findRequiredViewAsType(source, R.id.ac_yuan_qu, "field 'acYuanQu'", LinearLayout.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    SeachYuanQuAc target = this.target;
