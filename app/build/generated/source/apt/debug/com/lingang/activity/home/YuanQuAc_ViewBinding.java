...
public class YuanQuAc_ViewBinding implements Unbinder {
  private YuanQuAc target;
  ...
  @UiThread
  public YuanQuAc_ViewBinding(YuanQuAc target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public YuanQuAc_ViewBinding(final YuanQuAc target, View source) {
    this.target = target;
