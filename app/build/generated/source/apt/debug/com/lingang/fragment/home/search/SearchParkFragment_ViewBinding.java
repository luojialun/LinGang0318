...
public class SearchParkFragment_ViewBinding implements Unbinder {
  private SearchParkFragment target;

  @UiThread
  public SearchParkFragment_ViewBinding(SearchParkFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SearchParkFragment target = this.target;
