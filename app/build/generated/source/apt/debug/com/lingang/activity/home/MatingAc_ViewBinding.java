...
public class MatingAc_ViewBinding implements Unbinder {
  private MatingAc target;
  ...
  @UiThread
  public MatingAc_ViewBinding(MatingAc target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MatingAc_ViewBinding(final MatingAc target, View source) {
    this.target = target;
