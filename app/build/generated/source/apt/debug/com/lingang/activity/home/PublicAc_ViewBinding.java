...
public class PublicAc_ViewBinding implements Unbinder {
  private PublicAc target;
  ...
  @UiThread
  public PublicAc_ViewBinding(PublicAc target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PublicAc_ViewBinding(final PublicAc target, View source) {
    this.target = target;
