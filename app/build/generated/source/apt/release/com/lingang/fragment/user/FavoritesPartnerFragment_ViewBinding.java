...
public class FavoritesPartnerFragment_ViewBinding implements Unbinder {
  private FavoritesPartnerFragment target;

  @UiThread
  public FavoritesPartnerFragment_ViewBinding(FavoritesPartnerFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FavoritesPartnerFragment target = this.target;
