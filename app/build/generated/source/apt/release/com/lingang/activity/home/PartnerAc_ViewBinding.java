...
public class PartnerAc_ViewBinding implements Unbinder {
  private PartnerAc target;
  ...
  @UiThread
  public PartnerAc_ViewBinding(PartnerAc target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PartnerAc_ViewBinding(final PartnerAc target, View source) {
    this.target = target;
