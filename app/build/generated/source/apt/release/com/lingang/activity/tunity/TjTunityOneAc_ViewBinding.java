...
public class TjTunityOneAc_ViewBinding implements Unbinder {
  private TjTunityOneAc target;
  ...
  @UiThread
  public TjTunityOneAc_ViewBinding(TjTunityOneAc target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TjTunityOneAc_ViewBinding(final TjTunityOneAc target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TjTunityOneAc target = this.target;
