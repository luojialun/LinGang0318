...
public class PublicDetailsAc_ViewBinding implements Unbinder {
  private PublicDetailsAc target;
  ...
  @UiThread
  public PublicDetailsAc_ViewBinding(PublicDetailsAc target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PublicDetailsAc_ViewBinding(final PublicDetailsAc target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PublicDetailsAc target = this.target;
