...
public class FavoritesPublicFragment_ViewBinding implements Unbinder {
  private FavoritesPublicFragment target;

  @UiThread
  public FavoritesPublicFragment_ViewBinding(FavoritesPublicFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FavoritesPublicFragment target = this.target;
