...
public class FavoritesCompanyFragment_ViewBinding implements Unbinder {
  private FavoritesCompanyFragment target;

  @UiThread
  public FavoritesCompanyFragment_ViewBinding(FavoritesCompanyFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FavoritesCompanyFragment target = this.target;
