...
public class SearchPolicyFragment_ViewBinding implements Unbinder {
  private SearchPolicyFragment target;

  @UiThread
  public SearchPolicyFragment_ViewBinding(SearchPolicyFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SearchPolicyFragment target = this.target;
