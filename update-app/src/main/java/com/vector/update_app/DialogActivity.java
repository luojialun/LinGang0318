    ...
    private void initTheme() {
        ...
        if (-1 == topResId) {
            ...
            if (-1 == color) {
                ...
                setDialogTheme(color, topResId);  //更加指定的上色
            }
        }
    }
...
//            }
            //关闭状态回传
            setResult(UpdateAppManager.resultCloseCode,new Intent().putExtra("isForceUpdate",mUpdateApp.isConstraint()));
            finish();
            //onBackPressed();
        }
    }
        ...
        if (mUpdateApp != null) {
            ...
            binder.start(mUpdateApp, new DownloadService.DownloadCallback() {
                ...
                public void onProgress(float progress) {
                    if (!DialogActivity.this.isFinishing()) {
                        int curProgress=(int)((progress/downloadTotal) *100);
