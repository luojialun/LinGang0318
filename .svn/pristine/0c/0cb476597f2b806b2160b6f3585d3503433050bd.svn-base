 ...
 * 主页-评论列表adapter
 */
public class LvGroup2Adapter extends BaseAdapter {

    private Context context;
    private LayoutInflater mInflater;
    private List<NewsDetailsBean.NewsFileBean> data;
    private final DownLoadServicesUtils instance;

    public LvGroup2Adapter(Context context, List<NewsDetailsBean.NewsFileBean> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            int type = data.get(position).getFileType();
            switch (type) {
    ...
    private class Holder {
        ...
        private NewsDetailsBean.NewsFileBean fileBean;

        /**
         * 创建下载
         */
        public void createDownload(NewsDetailsBean.NewsFileBean fileBean, BaseAdapter apdater) {
