...
public class GridImageAdapter extends
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.mipmap.adding);
            ...
            switch (type) {
                case 1:
                    ...
                    GlideImgManager.glideLoader(mContext, path,viewHolder.mImg);
                    break;
                case 2:
                    // 视频
                    GlideImgManager.glideLoader(mContext, path,viewHolder.mImg,0.5f,R.mipmap.normal_img);
                    break;
            }
