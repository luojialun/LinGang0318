...
public abstract class RecycleBaseAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public static class VIEW_TYPE {
        ...
        public static final int ENTRYVIEW = 0x0012;
    }
    ...
    private int mEntryViewTypeValue = 999;//0x0108
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case VIEW_TYPE.FOOTER://footer
                ...
                break;
            case VIEW_TYPE.ENTRYVIEW://EntryView
                baseViewHolder = new BaseViewHolder(mInflater.inflate(layoutIdMap.get(mEntryViewTypeValue), parent, false), mContext);
                break;
            default:
    ...
    public int getItemViewType(int position) {
        ...
        if (mData.size() == 0) {//数据为空时加载空view样式
            layoutIdMap.put(mEntryViewTypeValue, R.layout.entry_layout);
            return VIEW_TYPE.ENTRYVIEW;
        } else {
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        Log.e("ssssss", "  mData.size() " + mData.size() + " VIEW_TYPE " + getItemViewType(position) + " position " + position);
        switch (getItemViewType(position)) {
            ...
            default:
                try {
                    ...
                    //☆☆☆☆提交到bugly☆☆☆☆
                    ToastUtils.showToast(mContext, "adapter数据渲染异常,请反馈...");
                    ex.printStackTrace();
                }
                addAnimation(holder);
                break;
    ...
    public class OnItemChildClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (mChildClickListener != null)
                mChildClickListener.onItemChildClick(RecycleBaseAdapter.this, v, mViewHolder.getLayoutPosition() - getHeaderViewCount() - 1);
        }
    }
    ...
    public class OnItemChildLongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            if (mChildLongClickListener != null) {
                return mChildLongClickListener.onItemChildLongClick(RecycleBaseAdapter.this, v, mViewHolder.getLayoutPosition() - getHeaderViewCount() - 1);
            }
            return false;
        }
    }
    ...
    public interface OnRecyclerViewItemChildClickListener {
        void onItemChildClick(RecycleBaseAdapter adapter, View view, int position);
    }

    public interface OnRecyclerViewItemChildLongClickListener {
        boolean onItemChildLongClick(RecycleBaseAdapter adapter, View view, int position);
    }
