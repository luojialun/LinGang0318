...
public class ChanYeJiQuanFragment extends BaseFragment implements RefreshListion, RecycleBaseAdapter.OnItemClickListener {
    ...
    private void initView() {
        ...
        clusterAdapter = new ClusterAdapter(getActivity(), clusterData);
    ...
    private void queryMessageList(final String pageIndex) {
        ...
        OkGo.post(HttpApi.queryMessageList)
                .params(httpParams)
                .execute(new ResCallBack<ClusterBean>(getActivity(), false) {
                    @Override
    ...
    public void onItemClick(View view, Object item, int position) {
        startActivity(new Intent(getActivity(), JiQunDetailsAc.class).putExtra("id", clusterData.get(position).getIndustryId()));
    }
}
