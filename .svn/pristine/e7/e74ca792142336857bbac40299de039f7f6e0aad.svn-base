...
public class OkGoUtil {
    ...
    public static OkGoUtil getInstance() {
        return OkGoUtil.OkGoHolder.holder;
    }
    ...
    /** 调试模式,默认打开所有的异常调试 */
    public OkGoUtil debug(String tag) {
     ...
     */
    public OkGoUtil debug(String tag, Level level, boolean isPrintException) {
    ...
    /** https的自定义域名访问规则 */
    public OkGoUtil setHostnameVerifier(HostnameVerifier hostnameVerifier) {
     ...
     * 用含有服务端公钥的证书校验服务端证书
     */
    public OkGoUtil setCertificates(InputStream... certificates) {
     ...
     */
    public OkGoUtil setCertificates(X509TrustManager trustManager) {
     ...
     */
    public OkGoUtil setCertificates(InputStream bksFile, String password, InputStream... certificates) {
     ...
     */
    public OkGoUtil setCertificates(InputStream bksFile, String password, X509TrustManager trustManager) {
    ...
    /** 全局cookie存取规则 */
    public OkGoUtil setCookieStore(CookieStore cookieStore) {
    ...
    /** 全局读取超时时间 */
    public OkGoUtil setReadTimeOut(long readTimeOut) {
        okHttpClientBuilder.readTimeout(readTimeOut, TimeUnit.MILLISECONDS);
        return this;
    }

    /** 全局写入超时时间 */
    public OkGoUtil setWriteTimeOut(long writeTimeout) {
        okHttpClientBuilder.writeTimeout(writeTimeout, TimeUnit.MILLISECONDS);
        return this;
    }

    /** 全局连接超时时间 */
    public OkGoUtil setConnectTimeout(long connectTimeout) {
        okHttpClientBuilder.connectTimeout(connectTimeout, TimeUnit.MILLISECONDS);
        return this;
    }

    /** 超时重试次数 */
    public OkGoUtil setRetryCount(int retryCount) {
    ...
    /** 全局的缓存模式 */
    public OkGoUtil setCacheMode(CacheMode cacheMode) {
    ...
    /** 全局的缓存过期时间 */
    public OkGoUtil setCacheTime(long cacheTime) {
    ...
    /** 添加全局公共请求参数 */
    public OkGoUtil addCommonParams(HttpParams commonParams) {
    ...
    /** 添加全局公共请求参数 */
    public OkGoUtil addCommonHeaders(HttpHeaders commonHeaders) {
    ...
    /** 添加全局拦截器 */
    public OkGoUtil addInterceptor(Interceptor interceptor) {
