...
public class DownloadInfo implements Comparable<DownloadInfo> {
    ...
    private int fileType;               //文件类型 1为pdf文件 2为视频文件
    ...
    public static ContentValues buildContentValues(DownloadInfo downloadInfo) {
        ...
        values.put(SHOW_NAME,downloadInfo.getShowName());
        ...
        values.put(FILE_TYPE, downloadInfo.getFileType());
        values.put(DOWNLOAD_TIME, downloadInfo.getDownloadTime());
    ...
    public static DownloadInfo parseCursorToBean(Cursor cursor) {
        ...
        info.setShowName(cursor.getString(cursor.getColumnIndex(DownloadInfo.SHOW_NAME)));
        ...
        info.setFileType(cursor.getInt(cursor.getColumnIndex(DownloadInfo.FILE_TYPE)));
        info.setDownloadTime(cursor.getLong(cursor.getColumnIndex(DownloadInfo.DOWNLOAD_TIME)));
