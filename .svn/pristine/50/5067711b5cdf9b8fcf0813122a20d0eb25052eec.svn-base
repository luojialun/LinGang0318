 ...
 * @class describe
 */
public class PolicyFragment extends BaseFragment implements RefreshListion ,RecycleBaseAdapter.OnItemClickListener{
    ...
    private void getPolicyPage(final String pageIndex) {
