 ...
 * @class describe
 */
public class OneLevelPop extends PopupWindow implements RecycleBaseAdapter.OnItemClickListener {
    ...
    public OneLevelPop(Context context, DialogConfirmListion listion) {
        super(context);
...
//        this.setAnimationStyle(R.style.AnimationPreview);
    ...
    public void setData(List<TypeListBean.DataBean.ListBean> data) {
        ...
        list = data;
        popLevelAdapter = new PopLevelAdapter(context, data);
    ...
    public void selectIndex(int index) {
        for (TypeListBean.DataBean.ListBean listBean :
                list) {
    ...
    public void onItemClick(View view, Object item, int position) {
        for (TypeListBean.DataBean.ListBean listBean : list
                ) {
            listBean.setIsselect(false);
        }
        list.get(position).setIsselect(!list.get(position).isselect());
        listion.confirmClick("type|" + list.get(position).getTypeId() + "|" + list.get(position).getTypeName());
